...
Para ver como puedo obtener una shell como `root` abusando de esta `capabilities`, puedo ir a la pagina de [GTFObins](https://gtfobins.github.io/gtfobins/python/)
