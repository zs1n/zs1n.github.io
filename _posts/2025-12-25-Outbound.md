...
Vemos que la version que corre para RounCube es una version vulnerable a una *deserialización de objetos PHP insegura*. La vulnerabilidad está en program/actions/settings/upload.php, donde el parámetro _from de la URL no se valida correctamente.
...
Ac continuacion un PoC para la explotacion de esta vulnerabilidad: 
