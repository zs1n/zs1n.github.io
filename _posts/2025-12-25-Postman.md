...
![image-center](/assets/images/Untitled 73.jpg)
...
>Esta vulnerabilidad tiene un impacto **Crítico** (CVSS: 10.0) y aplica a algunas versiones de Redis, incluyendo la serie 4.0, **pero solo en distribuciones Linux basadas en Debian y Ubuntu** (como Debian 9, 10, 11 y Ubuntu 20.04 LTS).
...
![image-center](/assets/images/Untitled 74.jpg)
