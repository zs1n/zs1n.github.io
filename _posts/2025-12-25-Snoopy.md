...
Vemos algunos subdominios relacionados a la maquina y a su dominio principal ( `snoopy.htb`), así que los colocamos dentro del archivo `/etc/hosts`.

## HTTP / Port 80

Por el puerto `80` vemos una pagina simple 

![image-center](/assets/images/Untitled 105.jpg)
...
![image-center](/assets/images/Untitled 108.jpg)
...
![image-center](/assets/images/Untitled 107.jpg)
...
![image-center](/assets/images/Untitled 109.jpg)

Y tocando en `View in Browser`, vemos la opción de solicitar un reseteo de password, podemos pensar en q la petición se realiza a `mail.snoopy.htb`, de manera que el correo de recuperación no se envía correctamente

![image-center](/assets/images/Untitled 110.jpg)
...
![image-center](/assets/images/image-20230509141822502.webp)
...
![image-center](/assets/images/Untitled 112.jpg)
...
![image-center](/assets/images/Untitled 113.jpg)
...
Welcome to Ubuntu 22.04.2 LTS (GNU/Linux 5.15.0-71-generic 
<SNIP>
