...
Vemos que intenta realizar una sanitización del código para evitar un `Path Traversal`, donde si detecta patrones como `../` los elimina, pero no lo hace de manera recursiva, de manera en la que podemos hacer algo como `....//....//` escapando de la sanitización.
