...
![-DBC21D45-32D4-41CA-8A4E-F7E4599458A3- 1](images/-DBC21D45-32D4-41CA-8A4E-F7E4599458A3- 1.png)

_Luego de ver el apartado de login me registre_

![-55A8DB80-EDD7-490F-83DA-1FD62E1DA490- 1](images/-55A8DB80-EDD7-490F-83DA-1FD62E1DA490- 1.png)
...
![Untitled 24 1](images/Untitled 24 1.jpg)
...
## Findings / Encuentros adicionales

Directorio `/var/www/soulmate.htb/config` un archivo de configuracion con las credenciales del administrador del subdominio
```php
cat config.php 
<?php
class Database {
...
Direcotorio `/var/www/soulmate.htb/data` encontre un archivo `sqlite` con el hash en formato `bcrypt`del usuario admin de `ftp.soulmate.htb`
...
`2774c1e27801adf6fcc9eb8c402eef45`
#### Root

`090fe45103b4f8c6e2666d1ea905731f`
